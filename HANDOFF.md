...
> پروژه فروشگاه «روزا» را ادامه بده. کد کامل در ریپازیتوری گیت‌هاب **[آدرس-ریپو]** است (اگر هنوز پوش نشده، بگو تا ساختار را از اول بسازی: سرور Node بدون وابستگی + SPA مطابق سند بالا).
