...
const DICT = {
  fa: {
    ...
    hero_m: 'ویدیوی سردر سایت (هیرو)', hero_title_f: 'عنوان روی ویدیو', hero_sub_f: 'زیرعنوان روی ویدیو', hero_h: 'ارتفاع ویدیو دسکتاپ (px)', hero_hm: 'ارتفاع ویدیو موبایل (px)', hero_hint: 'ویدیوی سینمایی «حلقه‌اندازی» به‌صورت خودکار پخش می‌شود؛ فقط متن‌ها و ارتفاع را ویرایش کنید.',
    payments_m: 'پرداخت و درگاه بانکی', pay_c2c: 'کارت به کارت', pay_gw_card: 'درگاه پرداخت اینترنتی', c2c_enable: 'روش کارت‌به‌کارت فعال باشد', gw_enable: 'درگاه اینترنتی فعال باشد', provider_f: 'شرکت درگاه', gw_name_f: 'نام نمایشی درگاه', token_f: 'مرچنت‌کد / توکن API', holder_fa: 'نام صاحب کارت (فا)', holder_en: 'نام صاحب کارت (EN)', c2c_note_f: 'متن راهنمای کارت‌به‌کارت', connect_hint: 'بدون برنامه‌نویسی: شماره کارت/شبا و نام صاحب کارت را وارد کنید یا مرچنت‌کد درگاه خود را بچسبانید و ذخیره کنید. اگر توکن خالی بماند، درگاه در حالت دمو کار می‌کند.',
    seo_m: 'دستیار سئو', seo_h: 'دستیار سئوی خودکار', seo_d: 'سلامت سایت برای گوگل و شبکه‌های اجتماعی بررسی و با یک کلیک تقویت می‌شود.', seo_score: 'امتیاز سئو', seo_auto: 'اعمال سئوی خودکار', seo_done: 'سئوی خودکار اعمال شد', seo_recheck: 'بررسی مجدد',
    change_pass: 'تغییر رمز ورود', exit_admin: 'خروج از پنل مدیریت', cur_pass: 'رمز فعلی', new_pass: 'رمز جدید', new_pass2: 'تکرار رمز جدید', pass_mismatch: 'تکرار رمز یکسان نیست', pass_changed: 'رمز ورود تغییر کرد',
  ...
  en: {
    ...
    hero_m: 'Home video hero', hero_title_f: 'Headline over the video', hero_sub_f: 'Subtitle over the video', hero_h: 'Video height desktop (px)', hero_hm: 'Video height mobile (px)', hero_hint: 'The cinematic “putting on the ring” video autoplays; edit only the texts and heights here.',
    payments_m: 'Payments & bank gateway', pay_c2c: 'Card to card', pay_gw_card: 'Online payment gateway', c2c_enable: 'Card-to-card method enabled', gw_enable: 'Online gateway enabled', provider_f: 'Gateway provider', gw_name_f: 'Gateway display name', token_f: 'Merchant ID / API token', holder_fa: 'Card holder (FA)', holder_en: 'Card holder (EN)', c2c_note_f: 'Card-to-card guide text', connect_hint: 'No coding: enter card/SHEBA + holder name, or paste your gateway merchant token and save. Empty token keeps the gateway in demo mode.',
    seo_m: 'SEO assistant', seo_h: 'Automatic SEO assistant', seo_d: 'Checks your site health for Google & socials and boosts it with one click.', seo_score: 'SEO score', seo_auto: 'Apply automatic SEO', seo_done: 'Automatic SEO applied', seo_recheck: 'Re-check',
    change_pass: 'Change password', exit_admin: 'Exit admin panel', cur_pass: 'Current password', new_pass: 'New password', new_pass2: 'Repeat new password', pass_mismatch: 'Passwords do not match', pass_changed: 'Password changed',
