...
const DICT = {
  fa: {
    ...
    sl_h: 'ارتفاع اسلایدر دسکتاپ (px)', sl_hm: 'ارتفاع اسلایدر موبایل (px)', sl_sub: 'نمایش زیرعنوان اسلایدر', sl_hint: 'متن، تصویر و لینک هر اسلاید از منوی «اسلایدرها» قابل مدیریت است.', sl_style: 'فرم اسلایدر', sl_style_card: 'کارت شناور (متن برند)', sl_style_product: 'ویترین محصول (نام + قیمت + خرید)',
  ...
  en: {
    ...
    sl_h: 'Slider height desktop (px)', sl_hm: 'Slider height mobile (px)', sl_sub: 'Show slider subtitle', sl_hint: 'Each slide text, image and link is managed under “Sliders”.', sl_style: 'Slider style', sl_style_card: 'Floating card (brand text)', sl_style_product: 'Product showcase (name + price + buy)',
