...
const DICT = {
  fa: {
    ...
    sl_h: 'ارتفاع اسلایدر دسکتاپ (px)', sl_hm: 'ارتفاع اسلایدر موبایل (px)', sl_sub: 'نمایش زیرعنوان اسلایدر', sl_hint: 'متن، تصویر و لینک هر اسلاید از منوی «اسلایدرها» قابل مدیریت است.',
  ...
  en: {
    ...
    sl_h: 'Slider height desktop (px)', sl_hm: 'Slider height mobile (px)', sl_sub: 'Show slider subtitle', sl_hint: 'Each slide text, image and link is managed under “Sliders”.',
